...
let CreateEventPageComponent = class CreateEventPageComponent {
    constructor(eventsService, alert) {
...
CreateEventPageComponent.ctorParameters = () => [
...
let DashboardEventPageComponent = class DashboardEventPageComponent {
    constructor(eventsService, alert) {
        this.eventsService = eventsService;
        this.alert = alert;
        this.events = [];
...
DashboardEventPageComponent.ctorParameters = () => [
...
let EditEventPageComponent = class EditEventPageComponent {
    constructor(route, eventsService, alert, router) {
        this.route = route;
        this.eventsService = eventsService;
        this.alert = alert;
        this.router = router;
    ...
    submit() {
        ...
        this.submitted = true;
        this.uSub = this.eventsService.update(Object.assign({}, this.event, { date: this.form.value.date, title: this.form.value.title, description: this.form.value.description, eventUserList: this.form.value.eventUserList })).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])((error) => {
            if (error.status === 403) {
...
EditEventPageComponent.ctorParameters = () => [
...
let CreateExpPageComponent = class CreateExpPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let DashboardExpPageComponent = class DashboardExpPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let EditExpPageComponent = class EditExpPageComponent {
    constructor() { }
    ngOnInit() {
    }
};
    ...
    ngOnInit() {
        this.route.queryParams.subscribe((params) => {
            if (params['loginAgain']) {
                this.message = 'Время сесии истекло. Пожалуйста, введите данные повторно';
            }
            else if (params['authFailed']) {
                this.message = 'Пожалуйста. Введите данные заного';
            }
        });
        this.form = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
...
let EventsService = class EventsService {
    ...
    getAll() {
        ...
        const r = this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API_ENDPOINT}/api/v1/event`)
    ...
    getById(id) {
        ...
        const r = this.http.get(`${_environments_environment__WEBPACK_IMPORTED_MODULE_4__["environment"].API_ENDPOINT}/api/v1/event/${id}`)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])((event) => event));
        console.log(r.toPromise());
        return r;
    }
    remove(id) {
...
let LocalizedCurrencyPipe = class LocalizedCurrencyPipe {
    transform(value, currencyCode = 'RUB', symbolDisplay = 'symbol-narrow', digits = null) {
